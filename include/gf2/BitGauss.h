...
public:
    ...
    /// Returns a solution to the system of linear equations `A.x_for = b` or `std::nullopt` if the system is
    /// inconsistent.
    ///
    ...
    /// Returns the `i`th solution to the system of linear equations `A.x_for = b` or `std::nullopt` if the
