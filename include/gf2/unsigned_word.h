...
/// See the [unsigned word](docs/pages/unsigned_word.md) page for more details.
...
// Our `unsigned_word` concept is the same as `std::unsigned_integral`
template<typename T>
concept unsigned_word = std::unsigned_integral<T>;
...
/// Returns the number of `unsigned_word`s needed to store `n_bits` bits.
///
/// # Example
/// ```
