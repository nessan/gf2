...
| Method                                   | Description                                                        |
| ---------------------------------------- | ------------------------------------------------------------------ |
| `gf2::BitMat::operator()(const BitVec&)` | Returns a solution to the equation $A \cdot x = b$.                |
| `gf2::BitMat::operator()(const BitMat&)` | Returns a solution to the collection of equations $A \cdot X = B$. |
