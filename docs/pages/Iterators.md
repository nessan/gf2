...
| `gf2::BitsIter`      | The non-const version reads and potentially mutates individual bits from a bit-store one at a time. |
...
You can create these iterators for any type that implements the `gf2::BitStore` interface, such as `gf2::BitVec`, `gf2::BitSet`, and `gf2::BitSpan` by using free functions or member functions.
...
More commonly you create the iterators by calling member functions defined in `gf2::BitVec`, `gf2::BitSet`, and `gf2::BitSpan`.
For example, `gf2::BitVec` defines the following member functions:

| Method                           | Description                                                           |
| -------------------------------- | --------------------------------------------------------------------- |
| `gf2::BitVec::bits const`        | Returns the **const** version of `gf2::BitsIter` for this vector.     |
| `gf2::BitVec::bits`              | Returns the **non-const** version of `gf2::BitsIter` for this vector. |
| `gf2::BitVec::set_bit_indices`   | Returns a `gf2::SetBitsIter` for this vector.                         |
| `gf2::BitVec::unset_bit_indices` | Returns a `gf2::UnsetBitsIter` for this vector.                       |
| `gf2::BitVec::store_words`       | Returns `gf2::WordsIter` for this vector.                             |
